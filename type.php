...
if (isset($_POST['new_Type'])) {
    ...
    try {
        ...
        //Creating a message
        $_SESSION['message'] = "Type Added successfully";
         }
        catch (Exception $e) {
            ...
            <div class="col-xs-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-cube"></i> New Type</h3>
                    </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="exampleInputProjectName">Type Name</label>
                                    <input type="text" class="form-control" name="name" id="exampleInputEmail1" placeholder="Type Name">
                                </div>
...
-->
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" class="btn btn-primary" value="Save" name="new_Type" />
                        </div>
                    </form>
                </div>
                <!-- /.modal-content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                               <?php
                                    $findall = R::findAll('type', 'Order BY id');
