...
-->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>Objects &amp; Fields</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="object-home.php"><i class="fa fa-circle-o"></i> Object Manager</a></li>            
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php base(); ?>new-project/"><i class="fa fa-circle-o"></i> New Project</a></li>
            <li><a href="<?php base(); ?>new-employee"><i class="fa fa-circle-o"></i> New Employee</a></li>
            <li><a href="<?php base(); ?>new-client"><i class="fa fa-circle-o"></i> New Client</a></li>            
          </ul>
        </li>
        <li>
          <a href="pages/widgets.php">
            <i class="fa fa-th"></i> <span>Object</span>
            <span class="pull-right-container">
