            ...
            <div class="col-xs-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-cube"></i> New Expense</h3>
                    </div>
                    <div class="box-body text-right">
<!--                        <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default">New</button>                  -->
                        <a href="" class="btn btn-default" data-toggle="modal" data-target="#modal-default">New</a>                  
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form role="form" method="post" action="">
                        <div class="modal-body">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputProjectName">Paid To</label>
                                    <input type="text" class="form-control" name="name" id="exampleInputEmail1" placeholder="Paid To">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type_id" class="form-control select2" style="width: 100%;">
                                      <option selected="selected" value="1">Salary</option>                                      
                                      <option value="2">Electric Bill</option>
                                      <option value="3">Office Rent</option>
                                      <option value="4">Ofiice Daily Cost</option>
                                    </select>
                                </div>
...
-->
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" class="btn btn-primary" value="Save" name="new_Expense" />
                        </div>
                    </form>
                </div>
                <!-- /.modal-content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                    $findall = R::findAll('expense', 'Order BY id');
