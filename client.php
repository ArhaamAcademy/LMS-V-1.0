            ...
            <div class="col-xs-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-cube"></i> New Client</h3>
                    </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type_id" class="form-control select2" style="width: 100%;">
                                      <option selected="selected" value="1">Long Term</option>                                      
                                      <option value="2">Shot Tearm</option>
...
-->
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" class="btn btn-primary" value="Save" name="new_client" />
                        </div>
                    </form>
                </div>
                <!-- /.modal-content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                               <?php
                                    $findall = R::findAll('client', 'Order BY id');
