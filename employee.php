            ...
            <div class="col-xs-12">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-cube"></i> New Employee</h3>
                    </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="exampleInputProjectName">Employee Name</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type_id" class="form-control select2" style="width: 100%;">
                                      <option selected="selected" value="1">Coordinator</option>                                      
                                      <option value="2">Project Manager</option>
                                      <option value="3">Project In Cherge</option>
                                      <option value="4">Manging Director</option>
...
-->
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="submit" class="btn btn-primary" value="Save" name="new_Employee" />
                        </div>
                    </form>
                </div>
                <!-- /.modal-content -->
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php
                                    $findall = R::findAll('employee', 'Order BY id');
