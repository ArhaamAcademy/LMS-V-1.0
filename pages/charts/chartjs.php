    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="chartjs.php"><i class="fa fa-circle-o"></i> ChartJS</a></li>
            <li><a href="morris.php"><i class="fa fa-circle-o"></i> Morris</a></li>
            <li><a href="flot.php"><i class="fa fa-circle-o"></i> Flot</a></li>
      ...
      datasets: [
        {
          ...
          data                : [<?php echo $janu_dw;?>, 59, 80, 81, 56, 55, 40]
        },
        {
          label               : 'Digital Goods',
          ...
          data                : [<?php echo $janu_up;?>, 48, 40, 19, 86, 27, 90]
        }
      ]
    }
